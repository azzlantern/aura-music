...
const TopBar: React.FC<TopBarProps> = ({
  ...
  const childClasses = (!isSidebarOpen && isTopBarActive)
    ? "opacity-100 translate-y-0 pointer-events-auto"
    : "opacity-0 -translate-y-3 pointer-events-none" + (isSidebarOpen ? "" : " group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto");
  const bgClasses = (!isSidebarOpen && isTopBarActive)
    ? "opacity-100"
    : "opacity-0" + (isSidebarOpen ? "" : " group-hover:opacity-100");
